...
union YYSTYPE
{
#line 17 "ass4_15CS10061.y" /* yacc.c:355  */
...
static const char *const yytname[] =
{
  ...
  "$accept", "primary_expression", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 163 "ass4_15CS10061.y" /* yacc.c:1646  */
    {
	if(currSymTable->isPresent(*((yyvsp[0].id)->strVal)))
		(yyval.express)->loc = currSymTable->lookUp(*((yyvsp[0].id)->strVal));
	else
		(yyval.express)->loc = globalSymTable->lookUp(*((yyvsp[0].id)->strVal));
	(yyval.express)->t = (yyval.express)->loc->t;
	(yyval.express)->array = (yyval.express)->loc;
	//$$->trueList = NULL;
	//$$->falseList = NULL;
	//$$.strLabel = -1;
}
...
#line 174 "ass4_15CS10061.y" /* yacc.c:1646  */
    {
	(yyval.express)->loc= currSymTable->genTemp(new type(_INT));
	(yyval.express)->t = (yyval.express)->loc->t;
	//$$->trueList = NULL;
    //$$->falseList = NULL;
    (yyval.express)->init.intVal = (yyvsp[0].intVal);
    // update the initial value of the temp variable generated
    currSymTable->update((yyval.express)->loc, (yyval.express)->init);
    // emit a quad assigning the value
	quadEntry q(OP_COPY, (yyval.express)->loc->name, (yyvsp[0].intVal));
   	quad->emit(q);
   	//$$->strLabel = -1;
}
#line 1353 "y.tab.c" /* yacc.c:1646  */
  ...
  case 4:
#line 187 "ass4_15CS10061.y" /* yacc.c:1646  */
    {
	(yyval.express)->loc= currSymTable->genTemp(new type(_DOUBLE));
	(yyval.express)->t = (yyval.express)->loc->t;
	//$$->trueList = NULL;
    //$$->falseList = NULL;
    (yyval.express)->init.doubleVal = (yyvsp[0].doubleVal);
    // update the initial value of the temp variable generated
    currSymTable->update((yyval.express)->loc, (yyval.express)->init);
    // emit a quad assigning the value
	quadEntry q(OP_COPY, (yyval.express)->loc->name, (yyvsp[0].doubleVal));
   	quad->emit(q);
   	//$$->strLabel = -1;
}
#line 1371 "y.tab.c" /* yacc.c:1646  */
  ...
  case 5:
#line 200 "ass4_15CS10061.y" /* yacc.c:1646  */
    {
	(yyval.express)->loc= currSymTable->genTemp(new type(_CHAR));
	(yyval.express)->t = (yyval.express)->loc->t;
	//$$->trueList = NULL;
    //$$->falseList = NULL;
    (yyval.express)->init.charVal = int((yyvsp[0].charVal));
    // update the initial value of the temp variable generated
    currSymTable->update((yyval.express)->loc, (yyval.express)->init);
    // emit a quad assigning the value
	quadEntry q(OP_COPY, (yyval.express)->loc->name, (yyvsp[0].charVal));
   	quad->emit(q);
   	//$$->strLabel = -1;
}
#line 1389 "y.tab.c" /* yacc.c:1646  */
  ...
  case 6:
#line 213 "ass4_15CS10061.y" /* yacc.c:1646  */
    {
...
#line 847 "ass4_15CS10061.y" /* yacc.c:1906  */
